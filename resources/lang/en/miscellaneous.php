...
return [
    ...
    'click_image' => 'Click to change picture',
    'drag_drop_default' => 'Drag and drop a file here or click',
    'drag_drop_replace' => 'Drag and drop or click to replace',
    'cancel' => 'Cancel',
    'details' => 'Details',
    ...
    'error_somewhere' => 'Oops, something is wrong!',
    'remove' => 'Remove',
    'delete' => 'Delete',
    'reset' => 'Reset',
    'open' => 'Open',
    ...
    'accept_terms_policy' => 'By clicking the “Get Started” button, you agree to <br class="d-sm-inline-block d-none">our <strong><a href="' . route('about.terms_of_use') . '">Terms of Use</a></strong> and <strong><a href="' . route('about.privacy_policy') . '">Privacy Policy</a></strong>.',
    ...
    'public' => [
        ...
        'home' => [
            'who_are_we' => [
                'title' => 'Who are we?',
                'content' => 'We are a foundation that supports the disadvantaged, particularly in the LUKUNGA district and throughout the Democratic Republic of Congo, to facilitate their socio-economic and cultural development.',
                'children' => [
                    'title' => 'Children',
                    'content' => 'who are enrolled in schools and who we care for in times of illness and other needs.'
                ],
                'partners' => [
                    'title' => 'Partners',
                    'content' => 'partners who contribute financially or otherwise to the advancement of the foundation.'
                ],
            ],
            'download_mobile_app' => [
        ...
        'about' => [
            ...
            'testimonials' => [
                'title' => 'Testimonials',
                'description' => 'We have received several testimonials from the public.',
            ],
            'other_links' => [
                'title' => 'Other links',
                'link1' => 'Terms of use',
