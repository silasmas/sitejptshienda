...
@section('auth-content')
    ...
    @if (Route::is('register'))
        ...
        @csrf
                                    <h3 class="h3 mb-sm-5 mb-4 text-center fw-bold">@lang('miscellaneous.register_title2')</h3>
        ...
        @endif
                                        ...
                                        <div class="col-12 text-center">
                                            <p class="mb-sm-4 mb-3 text-center" style="font-size: 0.8rem;">@lang('miscellaneous.accept_terms_policy')</p>

                                            <button class="btn btn-warning btn-sm-inline-block btn-block rounded-pill mb-4 py-3 px-5 shadow-0" type="submit">@lang('miscellaneous.start')</button>
    ...
    @if(Route::is('update'))
        ...
        @endif
                                    ...
                                    <!-- Run login -->
                                    <button type="submit" class="btn btn-primary btn-block py-3 mb-4 shadow-0">@lang('miscellaneous.register')</button>
                                </form>
    @endif
                            </div>
                        </div>
